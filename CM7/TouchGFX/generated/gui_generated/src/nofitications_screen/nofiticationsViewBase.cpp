...
nofiticationsViewBase::nofiticationsViewBase() :
    buttonCallback(this, &nofiticationsViewBase::buttonCallbackHandler)
{
    ...
    dee.setTypedText(touchgfx::TypedText(T___SINGLEUSE_054O));
    ...
    textArea1.setXY(364, 92);
    textArea1.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    textArea1.setLinespacing(0);
    textArea1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_GP7E));

    image18.setXY(319, 88);
    image18.setBitmap(touchgfx::Bitmap(BITMAP_BULB_ON_ID));
    ...
    digitalClock1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_9PWG));
...
void nofiticationsViewBase::setupScreen()
{

}

void nofiticationsViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &main_page)
    {
        //Interaction1
