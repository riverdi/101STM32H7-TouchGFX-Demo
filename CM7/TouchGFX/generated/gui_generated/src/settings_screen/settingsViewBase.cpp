    ...
    buttonCallback(this, &settingsViewBase::buttonCallbackHandler)
{
    ...
    dee.setTypedText(touchgfx::TypedText(T___SINGLEUSE_CCRS));
    ...
    settings_1.setXY(0, 597);
    settings_1.setBitmaps(touchgfx::Bitmap(BITMAP_SETTINGS2_ID), touchgfx::Bitmap(BITMAP_SETTINGS2_ID));

    textArea1.setXY(651, 361);
    textArea1.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    textArea1.setLinespacing(0);
    textArea1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_W7JS));
    ...
    digitalClock1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_XSSU));
