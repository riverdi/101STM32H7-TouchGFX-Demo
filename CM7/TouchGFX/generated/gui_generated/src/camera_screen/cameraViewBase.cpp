    ...
    buttonCallback(this, &cameraViewBase::buttonCallbackHandler)
{
    ...
    Image18.setXY(0, 0);
    Image18.setBitmap(touchgfx::Bitmap(BITMAP_CAMERAS_SCREEN_ID));
    ...
    dee.setTypedText(touchgfx::TypedText(T___SINGLEUSE_CJL8));
    ...
    cameras.setXY(0, 299);
    cameras.setBitmaps(touchgfx::Bitmap(BITMAP_CAMERAS2_ID), touchgfx::Bitmap(BITMAP_CAMERAS2_ID));
    ...
    digitalClock1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_P9UO));
