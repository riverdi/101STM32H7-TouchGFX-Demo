...
void MX_LTDC_Init(void)
{
  ...
  hltdc.Init.AccumulatedActiveW = 1375;
  hltdc.Init.AccumulatedActiveH = 826;
  hltdc.Init.TotalWidth = 1447;
  hltdc.Init.TotalHeigh = 841;
...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef* ltdcHandle)
{
  ...
  */
    ...
    PeriphClkInitStruct.PLL3.PLL3N = 182;
